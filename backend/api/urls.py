...
router.register(r'audio/get_chinese_speech_inspection', views.AudioFileUploadViewSet)
...
audio.register(r'get_chinese_speech_inspection', views.AudioFileUploadViewSet)
