...
class sensitiveClass:
    ...
    def check_sensitiveWords_test(self, df, input_word):
        ...
        for text in removeRepeartedArra:
            web_text = web_text.replace(text, "<a style='color:red'>"+text+"</a>")
        ...
        #web_text = changeText
        print("ccccccccccccc web_text=",web_text)
        t = time.time()
        endTime = int(round(t * 1000))
        print(endTime - startTime)
    ...
    def check_sensitiveWords(self, input_word):
        ...
        resultMap["sensitive_list"] = sensitive_list_result
        resultMap["final_list"] = aList
        print("aList=",aList)
...
if __name__ == '__main__':
    ...
    sensitiveClass().check_sensitiveWords_test(df, " 十八摸  我是台独分子   台独分子  独分子 十八摸")
